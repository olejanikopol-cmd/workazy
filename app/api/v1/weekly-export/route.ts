...
import { asc, desc, gte, inArray, lte } from "drizzle-orm";
...
const WEEKLY_EXPORT_TOKEN_SHA256 = "f4b53ff6a7077e7a3b81cc814362c9c61227b3bb5ba75e1afb382c6d8ffad45c";
...
export async function GET(request: Request) {
  ...
  if (!key || !safeEqual(providedHash, WEEKLY_EXPORT_TOKEN_SHA256)) {
  ...
  const finance = financeRows[0]?.value
    ? normalizeFinanceState(JSON.parse(financeRows[0].value))
    : null;
